...
const AnalysisBoard = lazy(() => import("@/pages/AnalysisBoard"));
// Profile
  ...
  return (
    <Routes>
      <Route element={<AppLayout />}>
        ...
        <Route path={ROUTES.TOOLS.IMPORT_GAME} element={<ImportGame />} />
        <Route path={ROUTES.TOOLS.ANALYSIS_BOARD} element={<AnalysisBoard />} />
      </Route>
